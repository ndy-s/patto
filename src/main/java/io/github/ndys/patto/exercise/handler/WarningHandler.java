...
public class WarningHandler extends RequestHandler {
    ...
    public void handleRequest(Request request) {
        ...
        //    (e.g., if request.getLevel() == RequestLevel.WARNING)
        // 2. If responsible:
        //    - "Process" the request (e.g., print a message indicating it was handled by WarningHandler).
