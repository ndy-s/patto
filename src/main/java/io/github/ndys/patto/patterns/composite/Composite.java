package io.github.ndys.patto.patterns.composite;

import java.util.Scanner;

import io.github.ndys.patto.exercise.ExerciseFacade;
import io.github.ndys.patto.patterns.composite.example1_file_system.Demo1;
...
public class Composite {
    ...
    public static void show(String menuPath) {
        ...
        while (true) {
            ...
            System.out.println("2. View Example: File System");
            ...
            switch (choice) {
                case 1 -> ExerciseFacade.start(scanner, "Composite");
                case 2 -> Demo1.run();
                case 0 -> {
                    return;
                }
