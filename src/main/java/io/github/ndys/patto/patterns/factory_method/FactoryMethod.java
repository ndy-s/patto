package io.github.ndys.patto.patterns.factory_method;

import java.util.Scanner;

import io.github.ndys.patto.exercise.ExerciseFacade;
import io.github.ndys.patto.patterns.factory_method.example1_notification_system.Demo1;
...
public class FactoryMethod {
    ...
    public static void show(String menuPath) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1 -> ExerciseFacade.start(scanner, "Factory Method");
                case 2 -> Demo1.run();
                case 0 -> {
                    return;
                }
