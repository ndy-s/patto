package io.github.ndys.patto.patterns.proxy;

import java.util.Scanner;

import io.github.ndys.patto.exercise.ExerciseFacade;
import io.github.ndys.patto.patterns.proxy.example1_image_loader.Demo1;
...
public class Proxy {
    ...
    public static void show(String menuPath) {
        ...
        while (true) {
            ...
            System.out.println("2. View Example: Image Loader Proxy");
            ...
            switch (choice) {
                case 1 -> ExerciseFacade.start(scanner, "Proxy");
                case 2 -> Demo1.run();
                case 0 -> {
                    return;
                }
